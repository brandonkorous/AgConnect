...
import { useWalletSuspense } from '@/lib/api/hooks/wallet';
...
function WalletInner({ locale }: { locale: string }) {
  const t = useTranslations('worker.wallet');
  const { data: items } = useWalletSuspense();
...
function SamplePreview() {
  const t = useTranslations('worker.wallet.sample');
  return (
