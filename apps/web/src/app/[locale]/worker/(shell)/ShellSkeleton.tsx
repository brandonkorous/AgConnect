...
// Full-page placeholder shown while WorkerShellClient resolves auth/onboarded
// state. Same layout footprint as the real shell so there's no layout shift
// when content swaps in: 248px sidebar column + top bar row + content area.
