...
import {
  useCurrentPayrollPeriodSuspense,
  usePayrollLinesSuspense,
  usePayrollSeasonSuspense,
  useH2aContextSuspense,
...
function PayrollInner() {
  ...
  const { data: period } = useCurrentPayrollPeriodSuspense();
  const { data: lines } = usePayrollLinesSuspense(period.id);
  const { data: season } = usePayrollSeasonSuspense();
  const { data: h2a } = useH2aContextSuspense();
