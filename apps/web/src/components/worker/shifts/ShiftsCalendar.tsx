        ...
        <div className="border-base-300 bg-base-100 overflow-hidden rounded-2xl border">
            ...
            <div className="border-base-300 grid grid-cols-7 border-b">
                {days.map((d) => (
                    <div
                        key={d}
                        className="text-base-content/60 px-3 py-2.5 font-mono text-xs font-bold uppercase tracking-[0.1em]"
                    >
                        {t(`weekday.${d}`)}
                    </div>
                ))}
                        ...
                        >
                            ...
                            {cellShifts.slice(0, 2).map((sh) => (
                                <div
                                    key={sh.id}
                                    className={[
                                        'mb-[3px] truncate rounded-[5px] px-[7px] py-1 text-xs font-semibold leading-tight',
                            ...
                            {cellShifts.length > 2 && (
                                <div className="bg-base-200 text-base-content/60 mb-[3px] truncate rounded-[5px] px-[7px] py-1 text-xs font-semibold">
                                    +{cellShifts.length - 2}
                                </div>
                            )}
                        </div>
