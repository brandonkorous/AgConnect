        ...
        >
            ...
            <div className="flex justify-end gap-1.5">
                <Link
                    ...
                    className="border-base-300 hover:bg-base-200 inline-flex items-center justify-center rounded-md border bg-transparent px-2 py-1 text-xs font-medium"
                >
                ...
                <button
                    ...
                    className="border-base-300 hover:bg-base-200 rounded-md border bg-transparent px-2 py-1 text-xs font-medium disabled:opacity-50"
                >
                    {t('table.edit')}
                </button>
                <button
                    ...
                    className={[
                        'rounded-md px-2.5 py-1 text-xs font-bold disabled:opacity-50',
                        optimisticApproved
