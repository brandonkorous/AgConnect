          ...
          {members.map((m) => {
            ...
            return (
              <li key={m.id} className="flex items-center gap-3 px-3.5 py-3">
                <span
                  className={[
                    'grid h-9 w-9 place-items-center rounded-full font-mono text-[11px] font-bold',
                ...
                {!isLead && (
                  <button
                    ...
                    className="text-base-content/60 hover:text-base-content inline-flex items-center gap-1 text-[11px]"
                  >
