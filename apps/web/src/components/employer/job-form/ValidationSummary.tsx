...
// each with a link that scrolls to the section. Replaces the old "Posting is
// missing required information." dead-end message.
...
export function ValidationSummary({ errors }: Props) {
    ...
    return (
        <div
            role="alert"
            aria-live="polite"
            className="border-error/40 bg-error/5 mb-5 rounded-2xl border p-4"
        >
