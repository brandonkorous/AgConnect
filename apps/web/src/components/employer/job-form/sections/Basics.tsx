            ...
            <div className="grid gap-4">
                <fieldset className="fieldset">
                    <legend className="fieldset-legend text-base-content/80 flex w-full items-baseline justify-between text-sm font-semibold">
                        ...
                        <span className="text-base-content/55 text-xs font-normal">{t('hint_title')}</span>
                    </legend>
                    <input
                        type="text"
                        required
                ...
                <fieldset className="fieldset">
                    <legend className="fieldset-legend text-base-content/80 flex w-full items-baseline justify-between text-sm font-semibold">
                        ...
                        <span className="text-base-content/55 text-xs font-normal">{t('hint_desc')}</span>
                    </legend>
                    <textarea
                        rows={4}
                ...
                <fieldset className="fieldset">
                    <legend className="fieldset-legend text-base-content/80 flex w-full items-baseline justify-between text-sm font-semibold">
                        ...
                        <span className="text-base-content/55 text-xs font-normal">{t('hint_photos')}</span>
                    </legend>
                    <PhotoGrid
                        jobId={jobId}
                        locale={locale}
