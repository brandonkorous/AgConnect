...
export function SectionNav({ sections }: Props) {
    ...
    return (
        <nav aria-label={t('section_nav_label')} className="hidden xl:block">
            <div className="text-base-content/60 px-2.5 pb-2 font-mono text-xs font-bold uppercase tracking-[0.1em]">
                {t('sections_heading')}
            </div>
                ...
                {sections.map((s) => {
                    ...
                    return (
                        <li key={s.key}>
                            ...
                            >
                                <span className="text-base-content/50 font-mono text-xs font-bold">
