  ...
  return (
    <div className="space-y-5 text-sm">
      ...
      <Section heading={t('source')}>
        ...
        <p className="text-base-content/55 mt-2 text-[11px] tabular-nums">
...
function Section({ heading, children }: { heading: string; children: React.ReactNode }) {
  return (
    <section>
      <h3 className="text-base-content/60 mb-1.5 text-[11px] font-semibold uppercase tracking-[0.18em]">
        {heading}
      </h3>
      {children}
    </section>
