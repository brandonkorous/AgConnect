        ...
        return (
          ...
          >
            ...
            <div className="min-w-0">
              ...
              <div className="text-base-content/60 mt-0.5 truncate text-[11px]">
            ...
            <div className="border-base-300 rounded-full border px-2.5 py-1 text-center text-[11px] font-semibold">
