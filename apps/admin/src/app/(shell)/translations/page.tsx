      ...
      {Array.from(groups.entries()).map(([namespace, items]) => (
        ...
        >
          <header className="bg-base-200 border-base-300 flex items-baseline justify-between border-b px-4 py-2.5">
            ...
            <span className="text-base-content/60 font-mono text-[11px] tabular-nums">
          ...
          <table className="w-full table-fixed">
            ...
            <thead>
              <tr className="border-base-300 border-b">
                <th className="text-base-content/60 px-4 py-2 text-left text-[11px] font-medium uppercase tracking-wide">
                  Key
                </th>
                <th className="text-base-content/60 px-3 py-2 text-left text-[11px] font-medium uppercase tracking-wide">
                  EN
                </th>
                <th className="text-base-content/60 px-3 py-2 text-left text-[11px] font-medium uppercase tracking-wide">
                  ES
