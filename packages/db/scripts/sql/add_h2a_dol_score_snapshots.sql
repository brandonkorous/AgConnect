-- Adds H-2A program participant flag, DOL inspection tracking, and
-- compliance score snapshots. Applied directly because the dev DB has
-- pre-existing partition drift on audit_events that blocks prisma db push.
