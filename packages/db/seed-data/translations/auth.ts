...
export const auth: TranslationBundle = {
    ...
    "pitch.employer.proof.p2": {
        en: "Worker search, broadcasts, multi-channel messaging (SMS, WhatsApp, in-app)",
        es: "Búsqueda de trabajadores, transmisiones, mensajería multicanal (SMS, WhatsApp, app)",
    },
