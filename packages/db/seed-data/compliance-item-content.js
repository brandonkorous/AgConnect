...
export const COMPLIANCE_ITEM_CONTENT = {
    // ────────────────────────────────────────────────────────────────────────
    // i_9_forms_on_file
    // Fetched 2026-05-03:
    ...
    i_9_forms_on_file: {
        why: {
            en: 'Federal law requires every employee — citizen or not — to complete Form I-9 to verify identity and authorization to work. The form has to be on file before the worker stays past their first three days.',
            es: 'La ley federal exige que cada trabajador — ciudadano o no — llene la forma I-9 para confirmar identidad y permiso de trabajo. La forma debe quedar archivada antes de que pasen los primeros tres días.',
        },
        how: [
            {
    ...
    i_9s_expiring_within_30_days: {
        why: {
            en: 'Some I-9 documents — like Employment Authorization Documents — expire. You have to reverify work authorization on or before the expiration date to keep employing the worker legally.',
            es: 'Algunos documentos de la I-9 — como las autorizaciones de empleo — se vencen. Tiene que re-verificar el permiso de trabajo en o antes de la fecha de vencimiento para seguir empleando al trabajador legalmente.',
        },
        how: [
            {
    ...
    w_4s_collected: {
        why: {
            en: 'The W-4 tells you how much federal income tax to withhold from each paycheck. You also have to keep W-4s and the rest of your employment-tax records for at least 4 years.',
            es: 'La forma W-4 le indica cuánto impuesto federal retener de cada cheque. También tiene que guardar las W-4 y los demás registros de impuestos por al menos 4 años.',
        },
        how: [
            {
    ...
    notice_of_intent: {
        why: {
            en: 'California restricts where, when, and how growers can apply certain pesticides. The Notice of Intent gives the County Agricultural Commissioner the chance to inspect and protect nearby workers, schools, and homes before the application happens.',
            es: 'California restringe dónde, cuándo y cómo se aplican ciertos pesticidas. El Aviso de Intención le permite al Comisionado Agrícola del condado revisar y proteger a los trabajadores, escuelas y casas vecinas antes de la aplicación.',
        },
        how: [
            {
    ...
    application_records_pur: {
        why: {
            en: 'California is the only state that collects monthly reports on every agricultural pesticide use. The data informs public health, school siting, and worker-safety decisions.',
            es: 'California es el único estado que recoge reportes mensuales de cada uso de pesticidas en la agricultura. Esta información apoya decisiones de salud pública, ubicación de escuelas y seguridad de los trabajadores.',
        },
        how: [
            {
    ...
    covid_19_prevention_plan: {
        why: {
            en: 'Cal/OSHA’s specific COVID-19 Prevention Non-Emergency Regulation expired February 3, 2025; the related recordkeeping requirement expired February 3, 2026. COVID-19 is now handled under your written Injury and Illness Prevention Program (IIPP) and standard Cal/OSHA hazard rules.',
            es: 'El reglamento específico de Cal/OSHA contra el COVID-19 venció el 3 de febrero de 2025, y la obligación de guardar registros venció el 3 de febrero de 2026. Ahora el COVID-19 se maneja bajo su Programa escrito de Prevención de Lesiones y Enfermedades (IIPP) y las reglas generales de Cal/OSHA.',
        },
        how: [
            {
    ...
    heat_illness_prevention_plan: {
        why: {
            en: 'California has the strictest outdoor-heat rules in the country. Every outdoor employer needs a written prevention plan, has to provide cool water and shade, and has to train workers — in the language they understand — before their first hot shift.',
            es: 'California tiene las reglas más estrictas del país contra el calor en el trabajo al aire libre. Cada empleador con trabajo al aire libre debe tener un plan escrito de prevención, dar agua fresca y sombra, y capacitar a los trabajadores — en el idioma que entiendan — antes de su primer turno caluroso.',
        },
        how: [
            {
    ...
    pesticide_handler_training_wps: {
        why: {
            en: 'Anyone who mixes, loads, or applies agricultural pesticides — or cleans the equipment, or handles unrinsed containers — has to be trained every year before they start. Training has to be in a language the handler understands.',
            es: 'Cualquier persona que mezcle, cargue o aplique pesticidas agrícolas — o limpie el equipo, o maneje envases sin enjuagar — debe ser capacitada cada año antes de empezar. La capacitación debe darse en un idioma que el trabajador entienda.',
        },
        how: [
            {
    ...
    overtime_calculations: {
        why: {
            en: 'California ag workers earn overtime at the same daily and weekly thresholds as workers in other industries: more than 8 hours a day or 40 hours a week, regardless of employer size. The phase-in finished January 1, 2025.',
            es: 'Los trabajadores agrícolas de California ganan tiempo extra a los mismos límites que los trabajadores de otras industrias: más de 8 horas al día o 40 horas a la semana, sin importar el tamaño del empleador. La transición terminó el 1 de enero de 2025.',
        },
        how: [
            {
    ...
    piece_rate_paid_breaks_tracked: {
        why: {
            en: 'Piece-rate workers in California have to be paid separately for rest and recovery periods, and for "other nonproductive time" — time when they’re under your control but not earning piece rate. The wage statement has to show those hours, the rate, and the gross pay.',
            es: 'Los trabajadores a destajo en California deben recibir pago aparte por los descansos y los periodos de recuperación, y por el “tiempo no productivo” — tiempo bajo su control pero sin estar produciendo a destajo. El talón de pago debe mostrar esas horas, la tarifa y el total pagado.',
        },
        how: [
            {
    ...
    itemized_wage_statements: {
        why: {
            en: 'California requires nine specific items on every wage statement. Missing or wrong items can trigger statutory penalties even when wages were paid correctly.',
            es: 'California exige nueve datos específicos en cada talón de pago. Si faltan o están mal, hay multas legales aunque el pago haya sido correcto.',
        },
        how: [
            {
...
export function getContentForItem(itemKey) {
