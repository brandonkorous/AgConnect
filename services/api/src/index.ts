...
import { adminDirectoryRoutes } from './admin/directory/routes.js';
import { adminEmployersRoutes } from './admin/employers/routes.js';
import { adminKpiRoutes } from './admin/kpi/routes.js';
import { adminMeRoutes } from './admin/me/routes.js';
import { adminOpsRoutes } from './admin/ops/routes.js';
import { adminSystemRoutes } from './admin/system/routes.js';
import { adminEmployerReportRoutes } from './admin/reports/employer-routes.js';
import { adminReportsRoutes } from './admin/reports/routes.js';
import { adminTrainingReportRoutes } from './admin/reports/training-routes.js';
import { adminTranslationsRoutes } from './admin/translations/routes.js';
import { adminWorkRoutes } from './admin/work/routes.js';
import { meRoutes } from './me/routes.js';
import { meInvitationsRoutes } from './me/invitations.js';
import { meEmployerInvitationsRoutes } from './me/employer-invitations.js';
...
import { employerMembersRoutes } from './employer/members/routes.js';
...
app.route('/v1/me/employer-invitations', meEmployerInvitationsRoutes);
...
app.route('/v1/employer/members', employerMembersRoutes);
...
app.route('/admin/v1/me', adminMeRoutes);
app.route('/admin/v1/directory', adminDirectoryRoutes);
app.route('/admin/v1/audit', adminAuditRoutes);
app.route('/admin/v1/employers', adminEmployersRoutes);
app.route('/admin/v1/kpi', adminKpiRoutes);
app.route('/admin/v1/reports', adminReportsRoutes);
app.route('/admin/v1/reports/training', adminTrainingReportRoutes);
app.route('/admin/v1/reports/employer', adminEmployerReportRoutes);
app.route('/admin/v1/translations', adminTranslationsRoutes);
app.route('/admin/v1/work', adminWorkRoutes);
app.route('/admin/v1/ops', adminOpsRoutes);
app.route('/admin/v1/system', adminSystemRoutes);
